...
/* There is a requirement for our implementation for our CW3:
"Think carefully about what shared data structures you need - Keep these to a minimum "
Here the number of shared data I use is 4 (2 integers and 2 arrays), does I meet the requirement to keep these to a minimum?*/
...
/**
 * The function firstly identifies either executing the chunk in local set or the chunk in the "most loaded" 
